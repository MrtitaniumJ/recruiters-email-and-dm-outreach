...
async function discoverJobsForCompany(page, companyConfig, config) {
    ...
    return page.evaluate((companyName, hintFragments) => {
        ...
        // ⚡ Bolt: Use explicit for loops instead of .some() in this hot loop to prevent anonymous function allocations
        ...
        // ⚡ Bolt: Use explicit for loops instead of .some() here to prevent anonymous function allocations in hot path
